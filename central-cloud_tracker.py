...
HOSTNAME = '0.0.0.0'    # All Ipv4 listening
PORT = 3000             # Any port, taking it as 3000
BUFFER = 65536          # Max buffer
...
class central_server_class():
    ...
    # Registering peer to the central tracker    
    ...
    # Indexing the files, They are now in {file_name: [peer1,peer2..]} format.
    ...
    def process_request(self):
        ...
        print 'Press control+c to shutdown the central server.!!'
        print '*'*80
        infinite = 1
